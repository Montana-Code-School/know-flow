...
import {FE_Marker} from './fe-marker';

export const FE_MarkerManager = React.createClass({
  propTypes: {
  ...
  render() {
    ...
    const markers = accesses.map((a, i) => <FE_Marker key={a._id} access={a} mode={modes[i]} onClick={this.props.accessClickHandler} /> );
