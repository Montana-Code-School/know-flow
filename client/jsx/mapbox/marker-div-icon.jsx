...
export const MarkerDivIcon = React.createClass({
  ...
  render() {
    ...
    const icon = L.divIcon({iconSize, iconAnchor, popupAnchor, className, html: ReactDOMServer.renderToString(children)});
